Gem::Specification.new do |s|
  ...
  s.files       = ["lib/redis_batch.rb", "lib/redis_batch/client.rb", "lib/redis_batch/lua.rb", "lib/redis_batch/queue.rb", "lib/redis_batch/configurable.rb", "LICENSE", "README.md"]
